...
const Circle = ({isActive, imageUrl}) => {
  ...
  return (
    <div style={ { 'backgroundImage': `Url('${isActive ? imageUrl : icon}')`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' } } className={[styles.progressCircle, isActive ? styles.activated : styles.inactive].join(" ")} />
  )
}
